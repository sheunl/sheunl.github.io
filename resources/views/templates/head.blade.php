...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-96N7FDW343"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-96N7FDW343');
    </script>
    <meta charset="UTF-8">
    ...
    <link rel="icon" type="image/x-icon" href="/static/images/Zaqlabs_logo_s.png">
    <link rel="stylesheet" href="/static/styles/style.css">
    <title>Zaqlabs | Full Stack Web & Linux</title>
</head>
<body>
<nav id="navmenu">
                <div class="logo">
